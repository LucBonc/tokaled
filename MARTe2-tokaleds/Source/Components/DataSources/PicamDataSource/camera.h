...
private:
	...
	bool Init(int width, int height, int framerate, int num_levels, bool do_argb_conversion,bool start);
	void Release();
	...
	friend CCamera* StartCamera(int width, int height, int framerate, int num_levels, bool do_argb_conversion,bool startCapture);
